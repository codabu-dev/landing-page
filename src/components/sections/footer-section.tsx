...
const FooterSection = () => {
  return (
    <section
      id='footer'
      className='flex flex-col justify-center items-center w-full px-4 sm:px-6 lg:px-8 pt-10 sm:pt-16 lg:pt-20 pb-10 bg-black text-white'
    >
      <div className='flex flex-col w-full max-w-7xl text-left gap-2'>
        ...
        <div className='flex flex-col md:flex-row justify-between items-start md:items-center gap-4 text-neutral-400 text-sm'>
          <div>© {new Date().getFullYear()} Codabu. All rights reserved.</div>
